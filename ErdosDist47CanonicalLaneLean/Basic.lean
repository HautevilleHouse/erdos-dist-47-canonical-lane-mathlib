/-!
# erdos-dist-47 Lean migration boundary
...
`erdos_dist_47/SourcePackage.lean`.
...
def sourceRepository : String := "erdos-dist-47"
def sourceUrl : String := "https://github.com/HautevilleHouse/erdos-dist-47"
def sourceDescription : String := "Canonical-lane closure package for the Erdős Distinct Distances (n=47): admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["erdos-dist-47", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
