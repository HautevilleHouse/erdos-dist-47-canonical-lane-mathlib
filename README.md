# Erdős Distinct Distances (n=47) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Erdős Distinct Distances (n=47).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/erdos-dist-47-mathlib.git
cd erdos-dist-47-mathlib
lake exe
lake build
```
